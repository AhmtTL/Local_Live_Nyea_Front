...
export const programConfigs = {
    "academic-consulting": {
        ...
        packages: [
            {
                ...
                features: ["Academic assessment & planning", "University selection guidance", "Application strategy", "Essay review & feedback", "Interview preparation"],
            },
            {
                name: "Premier",
                price: 3499,
        ...
        overview:
            "Our Academic Consulting program provides comprehensive university admission strategy and academic planning. We work closely with students to identify their strengths, align their goals, and create a roadmap for success in higher education.",
        ...
        testimonials: [
            {
                name: "Sarah Chen",
                role: "Ivy League University Student",
                university: "Ivy League University",
                content:
                    "The academic consulting program transformed my university application process. I received guidance that helped me get into Ivy League with a full scholarship.",
        ...
        packages: [
            {
                ...
                features: ["Career assessment & planning", "Resume & LinkedIn optimization", "Interview preparation", "Industry insights", "Job search strategy"],
            },
            {
                name: "Professional",
                price: 2999,
            ...
            },
            {
                ...
                features: ["Everything in Professional", "C-suite mentor access", "Executive coaching", "Board preparation", "Leadership development", "Long-term career strategy"],
            },
        ],

        overview:
            "Our Career Consulting program bridges the gap between education and professional success. We provide strategic career planning, industry connections, and professional development to accelerate your career trajectory.",
        ...
        packages: [
            {
                ...
                features: ["Monthly mentor sessions", "Goal setting & tracking", "Resource recommendations", "Email support", "Progress reviews"],
            },
            {
                name: "Premium",
                price: 1999,
            ...
            },
            {
                ...
                features: ["Everything in Premium", "Weekly mentor access", "Multiple mentor matching", "Executive coaching", "Speaking opportunities", "Alumni network access"],
            },
        ],

        overview:
            "Our Elite Mentorship Program connects ambitious students with successful professionals who provide personalized guidance, industry insights, and career acceleration opportunities.",

        targetAudience: ["Ambitious students seeking guidance", "Young professionals starting careers", "Entrepreneurs building ventures", "Anyone seeking personal development"],
    ...
    "cambridge-training": {
        ...
        packages: [
            {
                ...
                features: ["Cambridge curriculum access", "Faculty-led sessions", "Academic writing training", "Research methodology", "Official certificate"],
            },
            {
                name: "Diploma",
                price: 4999,
                ...
                features: ["Everything in Certificate", "Extended curriculum", "One-on-one tutorials", "Research project", "Cambridge diploma", "Alumni network access"],
            },
            {
                name: "Fellowship",
                price: 7999,
        ...
        overview:
            "Our Cambridge Training program offers authentic Cambridge University education through certified courses, distinguished faculty, and rigorous academic standards that prepare students for world-class university success.",

        targetAudience: ["Students applying to top universities", "Academic high achievers", "International students", "Future researchers and scholars"],
        ...
        testimonials: [
            ...
            {
                name: "James Wilson",
                role: "Ivy League Graduate",
                university: "Ivy League",
                content: "The Cambridge certification was a key factor in my Ivy League admission. The academic training exceeded all expectations.",
                image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80",
                rating: 5,
            },
        ],

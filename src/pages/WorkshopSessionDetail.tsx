...
import { ArrowLeft, CheckCircle, Shield, Star, Loader2, ShoppingCart, X, Share2, Check, CreditCard, CheckCircle2 } from "lucide-react";
...
const premierWorkshop = {
    ...
    features: [
        // "Led by IVY League University Instructor",
        "Led by Ivy League Instructor",
        "Professional Certificate",
        // "Ivy League-style Leadership Vocabulary",
...
const WorkshopSessionDetail: React.FC = () => {
            ...
            try {
                ...
                if (response.success && response.data) {
                    ...
                    setWorkshopProgram({
                        ...
                        price: programData.price ? parseFloat(programData.price) : premierWorkshop.price,
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <div className="text-center">
                        <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-md mx-auto">
                            ...
                            <Button onClick={() => navigate(`/workshop-booking/${workshop}`)} variant="outline" className="border-red-300 text-red-700 hover:bg-red-50">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                    ...
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        <div className="flex items-center mb-3 sm:mb-4 flex-wrap gap-2">
                            ...
                            <span className="text-yellow-400 font-semibold text-sm sm:text-base">Premier Workshop Session</span>
                        ...
                        <p className="text-base sm:text-lg lg:text-xl text-gray-200 max-w-3xl leading-relaxed">{workshopProgram?.description || premierWorkshop.description}</p>
                    </motion.div>
                </div>
            </section>
                                            ...
                                            <div className="flex items-center gap-3">
                                                <div className="flex-1 flex gap-3">
                                                    ...
                                                    <Button
                                                        ...
                                                        disabled={isBooking}
                                                        size="lg"
                                                        className="flex-1 w-full bg-gradient-to-r from-[#9f162e] to-[#1f2444] hover:from-[#1f2444] hover:to-[#9f162e] text-white font-bold px-5 py-4 text-base shadow-lg transition-all duration-200 disabled:opacity-50 h-12"
                                                    >
                                                        {isBooking ? (
                                                            <>
                                ...
                                <Card className="shadow-lg border-0 bg-white">
                                    <CardContent className="p-4 sm:p-6 space-y-6">
                                        ...
                                        <div>
                                            ...
                                            />
                                            <h3 className="font-bold text-gray-900 mb-2 text-base sm:text-lg">{workshopProgram?.title || premierWorkshop.title}</h3>
                                            <p className="text-xs sm:text-sm text-gray-600 mb-4">{workshopProgram?.description || premierWorkshop.description}</p>
                                        </div>

                                        {/* Features */}
                                        <div className="border-t pt-6 space-y-3">
                                            <h4 className="font-semibold text-gray-900 text-sm sm:text-base mb-3">What's Included</h4>
                                            {(workshopProgram?.features || premierWorkshop.features).map((feature: string, index: number) => (
                                    ...
                                    <Card className="hidden">
                                        <CardContent className="p-4 space-y-3 w-full">
                                            ...
                                            <Button
                                                ...
                                                disabled={isBooking}
                                                size="lg"
                                                className="w-full bg-gradient-to-r from-[#9f162e] to-[#1f2444] hover:from-[#1f2444] hover:to-[#9f162e] text-white font-bold py-4 text-base shadow-lg transition-all duration-200 disabled:opacity-50"
                                            >
                                                {isBooking ? (
                                                    <>
                                                        <Loader2 className="h-5 w-5 mr-2 animate-spin" />
            ...
            {/* Enroll Now and Share Buttons - Fixed to Viewport Bottom - Mobile Only */}
            {session.availableSpots > 0 && (

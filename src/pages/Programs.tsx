...
const Programs: React.FC = () => {
    ...
    const filteredPrograms = programs.filter(program => {
        // Hide NASA Space Training program with price $6,333
        const price = typeof program.price === "string" ? parseFloat(program.price) : program.price;
        const isNASA6333 = (program.slug === "nasa-space-training" || program.title?.toLowerCase().includes("nasa space training")) && 
                          (price === 6333 || price === 6333.00 || Math.abs(price - 6333) < 0.01);
        if (isNASA6333) return false;
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12 md:mb-20">
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-black text-white mb-8 leading-tight">
                        ACADEMIC EXCELLENCE
                        <span className="block bg-gradient-to-r from-blue-400 via-purple-500 to-indigo-500 bg-clip-text text-transparent">PROGRAMS</span>
                    </h1>
                    <p className="text-sm md:text-md lg:text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed">
                        Discover comprehensive educational programs designed for academic excellence and career success. Each program is carefully crafted for transformational
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <option value="under-1000" className="bg-gray-800">
                                    UNDER $1,000
                                </option>
                                <option value="1000-2000" className="bg-gray-800">
                                    $1,000 - $2,000
                                </option>
                                <option value="over-2000" className="bg-gray-800">
                                    OVER $2,000
                                </option>
                            </select>
                        </div>
                    ...
                    <div className="bg-gradient-to-r from-blue-400/10 to-purple-500/10 backdrop-blur-md rounded-3xl border border-blue-400/20 p-6 md:p-12 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-white mb-6 leading-tight">
                                NEED SPECIALIZED
                                <span className="block bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">PROGRAMS?</span>
                            </h2>
                            <p className="text-sm md:text-md lg:text-lg text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
                                We design custom educational programs for institutions and organizations. Contact our academic team to discuss your specific educational
                                requirements.
                            </p>
                            <Link
                                to="/contact"

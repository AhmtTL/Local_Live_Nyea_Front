...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Backend API URL - Define REACT_APP_API_BASE_URL in your .env file
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Ready to start your educational journey? Let's connect and shape
                ...
                {[
                  {
                    ...
                    onClick: () =>
                      window.open("mailto:hello@nyempireacademy.com", "_self"),
                  },
                  {
                    icon: Phone,
                    label: "Call Us",

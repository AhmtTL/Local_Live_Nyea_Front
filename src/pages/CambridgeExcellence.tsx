...
const CambridgeExcellence: React.FC = () => {
    ...
    const scrollToSection = (id: string) => {
        ...
        if (element) {
            const headerOffset = 120; // Offset for Header + AnnouncementBar height
    ...
    const packages = [
        {
            ...
            popular: false,
            features: ["Cambridge curriculum access", "Faculty-led sessions", "Academic writing training", "Research methodology", "Official Cambridge certificate"],
        },
        {
            id: "advanced",
    ...
    const testimonials = [
        {
            ...
            content:
                "The Cambridge Excellence Program was instrumental in my Ivy League acceptance. The research methodology training and writing skills I gained were invaluable.",
            rating: 5,
        },
        {
        ...
        <div className="min-h-screen bg-white">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 relative">
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-center">
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black mb-6 leading-tight">
                            CAMBRIDGE
                            <span className="block bg-gradient-to-r from-blue-400 via-cyan-300 to-purple-300 bg-clip-text text-transparent">EXCELLENCE</span>
                            <span className="block text-3xl md:text-4xl lg:text-5xl font-bold text-blue-200">PROGRAM</span>
                        </h1>

                        <p className="text-lg md:text-xl text-blue-200 max-w-4xl mx-auto mb-8 leading-relaxed">
                            Official Cambridge University certified programs for academic and professional excellence. Experience the same academic rigor and world-class education
                            that Cambridge students receive.
                        </p>
            ...
            <section id="about" className="py-16 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Why Choose Cambridge Excellence?</h2>
            ...
            <section id="packages" className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Choose Your Cambridge Journey</h2>
                        <p className="text-gray-600 text-lg max-w-3xl mx-auto">Select the program that best fits your academic goals and timeline.</p>
                    </motion.div>
                            ...
                            >
                                {pkg.popular && (
                                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                                        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-1 rounded-full text-sm font-semibold">Most Popular</div>
                                    </div>
                                )}
                                ...
                                <div className="p-8">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => {
                                            // Create a program object for the selected package
                                            const program = {
                                                id: 999 + index, // Unique ID for each package
                                                title: `Cambridge Excellence - ${pkg.name}`,
                                                slug: "cambridge-training",
                                                description: "Official Cambridge University certified program for academic and professional excellence.",
                                                price: pkg.price,
                                                formatted_price: `$${pkg.price.toLocaleString()}`,
                                                duration: pkg.duration,
                                                category: "Cambridge Training",
                                                image: "/images/cambridge-excellence.jpg",
            ...
            <section className="py-16 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-gray-600 text-lg">Get answers to common questions about the Cambridge Excellence Program.</p>
                    </motion.div>
                        ...
                        {faqs.map((faq, index) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <ArrowRight className={`h-5 w-5 text-gray-500 transform transition-transform ${expandedFAQ === index ? "rotate-90" : ""}`} />
                                </button>
                                <AnimatePresence>
                                    {expandedFAQ === index && (
                                        <motion.div
            ...
            <section className="py-16 bg-gradient-to-br from-indigo-900 via-blue-900 to-purple-900 text-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Begin Your Cambridge Journey?</h2>
                        <p className="text-blue-200 text-lg mb-8 max-w-2xl mx-auto">
                            Join thousands of successful graduates who have transformed their academic and professional futures through Cambridge Excellence certification.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Button size="lg" className="bg-white text-blue-900 hover:bg-gray-100" onClick={() => scrollToSection("packages")}>
                                <span className="flex items-center">
                                    Apply Now
                                    <ArrowRight className="ml-2 h-5 w-5" />
                                </span>

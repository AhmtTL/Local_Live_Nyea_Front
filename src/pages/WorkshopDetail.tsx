...
import { ArrowLeft, CheckCircle, Star, Shield, Users, Clock, Calendar, Award, BookOpen, Target, TrendingUp, Globe, ArrowRight, X, Monitor } from "lucide-react";
...
const workshopData: Record<string, any> = {
    "leadership-negotiation-communication": {
        ...
        subtitle: "Master Essential Leadership Skills with Ivy League-Affiliated Instruction",
        description:
            "An intensive workshop designed to transform your leadership capabilities through proven Ivy League methodologies. Led by Nicholas Coburn-Palo, this program combines theoretical foundations with practical applications to develop your negotiation prowess, communication excellence, and leadership presence.",
        instructor: {
            name: "Nicholas Coburn-Palo",
            credentials: "Ivy League Instructor",
            image: "/images/nicholas-coburn-palo.svg",
        },
        objectives: [
            "Develop authentic leadership presence and communication style",
            "Master IVY League-proven negotiation strategies and tactics",
        ...
        curriculum: [
            {
                ...
                topics: [
                    ...
                    "Ivy League-style leadership vocabulary and frameworks",
            ...
            },
            {
                ...
                topics: ["Real-time case study simulations", "Decision-making under pressure", "Change management and transformation", "Building high-performance teams"],
            },
        ],
        highlights: [
            "Discover your leadership identity",
            "Learn leadership vocabulary choice",
        ...
        benefits: [
            ...
            "Master negotiation skills through elite, research-backed methods",
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-[#1f2444] via-[#2d3d66] to-[#9f162e]">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-8">
                        <Button variant="outline" asChild className="border-white/30 text-white hover:bg-white/10 backdrop-blur-sm">
                            {/* <Link to="/elite-workshops">
                <ArrowLeft className="h-4 w-4 mr-2" />
                Back to Elite Workshops
              </Link> */}
                ...
                CPDUK ACCREDITED PROGRAM
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight mb-6">{data.title}</h1>

                            <p className="text-xl text-white/90 mb-8 leading-relaxed">{data.subtitle}</p>
                    ...
                    />
                        ...
                        {/* Instructor Card */}
                        <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="lg:justify-self-end">
            ...
            <section className="py-16 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="text-center">
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed text-center">{data.description}</p>
                    </motion.div>
                </div>
            </section>

            {/* Programme Types Comparison */}
            <section id="choose-format" className="py-16 bg-white scroll-mt-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Choose Your Program Format</h2>
                        <p className="text-xl text-gray-600">Select the format that best fits your schedule and learning preferences</p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
                        ...
                        >
                            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                                <span className="bg-gradient-to-r from-[#9f162e] to-orange-500 text-white px-4 py-1 rounded-full text-sm font-semibold">MOST POPULAR</span>
                            </div>
                            ...
                            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-8 border-2 border-yellow-200 h-full">
                                ...
                                <div className="space-y-4 mb-8">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-gray-900">December</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="font-medium text-gray-700 flex items-center">
                            ...
                            <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-8 border-2 border-gray-200 h-full">
                                ...
                                <div className="space-y-3 mb-8">
                                    {[
                                        ...
                                        {
                                            feature: "Additional 5 hours of small group coaching",
                                            included: false,
                                        },
                                        {
                                            feature: "Personalized recommendations on Professional development & university admissions",
                                            included: false,
                                        },
                                        {
                                            feature: "Private networking dinner with workshop lecturers",
                                            included: false,
                                        },
                                    ].map((item, index) => (
                                        <div key={index} className="flex items-center">
                                            ...
                                            <span className={`text-sm ${item.included ? "text-gray-700" : "text-gray-400"}`}>{item.feature}</span>
                                        </div>
                                    ))}
                                </div>
            ...
            <section className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div
                        ...
                        className="text-center mb-12"
                    >
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">What Makes Our Program Unique</h2>
                        <p className="text-xl text-gray-600">Experience transformative learning through real-world applications and expert guidance</p>
                    </motion.div>
                            ...
                            <div className="relative h-80 rounded-2xl overflow-hidden">
                                ...
                                <div className="absolute inset-0 p-6 flex flex-col justify-center text-white">
                                    <div className="text-center">
                                        ...
                                        <p className="text-sm leading-relaxed">Work alongside industry executives and gain their exclusive insider advice on how to succeed.</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                            ...
                            <div className="relative h-80 rounded-2xl overflow-hidden">
                                ...
                                <div className="absolute inset-0 p-6 flex flex-col justify-center text-white">
                                    <div className="text-center">
                                        ...
                                        <p className="text-sm leading-relaxed">Receive personalized guidance from Ivy League-affiliated instructors and industry leaders.</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              A structured learning journey designed by Ivy League-affiliated experts
            </p>
          </motion.div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                                ...
                                <div className="absolute bottom-8 left-8 right-8">
                                    <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-xl">
                                        ...
                                        <p className="text-gray-700 leading-relaxed">
                                            "This workshop didn't just teach me skills—it fundamentally changed how I approach leadership and communication. The confidence and
                                            strategic thinking I've gained have opened doors I never imagined possible."
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    >
                        <div className="relative rounded-2xl overflow-hidden shadow-lg group">
                            <img src="/images/4.png" alt="Workshop success story" className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-500" />
                        ...
                        <div className="relative rounded-2xl overflow-hidden shadow-lg group">
                            <img src="/images/2.png" alt="Achievement celebration" className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-500" />
                            <div className="absolute inset-0 bg-gradient-to-t from-[#1f2444]/50 to-transparent"></div>
                            <div className="absolute bottom-4 left-4 text-white">
                        ...
                        <div className="relative rounded-2xl overflow-hidden shadow-lg group">
                            <img src="/images/1.png" alt="Future leaders" className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-500" />
                            <div className="absolute inset-0 bg-gradient-to-t from-[#1f2444]/50 to-transparent"></div>
                            <div className="absolute bottom-4 left-4 text-white">
            ...
            <section className="py-16 bg-gray-50">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600">Get answers to common questions about our leadership workshop</p>
                    </motion.div>
                        ...
                        {[
                            {
                                ...
                                // answer: "Our workshop is led by Ivy League-affiliated instructors and combines theoretical knowledge with practical application through real-world simulations. You'll receive CPDUK accreditation and have opportunities for personalized mentorship and networking with industry professionals."
                                answer: "Our workshop is led by Ivy League-affiliated instructors and combines theoretical knowledge with practical application through real-world simulations. You'll receive professional certification and have opportunities for personalized mentorship and networking with industry professionals.",
                            },
                            {
                            ...
                            },
                            {
                                ...
                                // answer: "The CPDUK (Continuing Professional Development UK) accreditation provides formal recognition of your professional development. You'll receive a certificate signed by Ivy League-affiliated instructors, which can enhance your CV and demonstrate your commitment to continuous learning."
                                question: "What is included in the professional certification?",
                                answer: "The professional certification provides formal recognition of your professional development. You'll receive a certificate signed by Ivy League-affiliated instructors, which can enhance your CV and demonstrate your commitment to continuous learning.",
                            },
                            {
                    ...
                    >
                        <div className="bg-gradient-to-r from-[#1f2444] to-[#9f162e] rounded-2xl p-8 text-white">
                            ...
                            <p className="mb-6 text-white/90">Our team is here to help you make the right decision for your professional development.</p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <Button size="lg" className="bg-white text-[#1f2444] hover:bg-gray-100 font-semibold">
                                    Contact Our Team
                                </Button>
                                {/* <Button
                  size="lg"
            ...
            <section className="py-16 bg-gradient-to-r from-[#1f2444] to-[#9f162e]">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to Transform Your Leadership?</h2>
                        <p className="text-xl text-white/90 mb-8">Join hundreds of professionals who have elevated their careers through our Ivy League-affiliated programs.</p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <Button size="lg" variant="outline" className="border-2 border-white hover:bg-white hover:text-[#1f2444] font-semibold">

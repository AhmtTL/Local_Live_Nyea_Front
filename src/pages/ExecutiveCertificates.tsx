...
const ExecutiveCertificates: React.FC = () => {
    ...
    const benefits = [
        {
            ...
            desc: "Live sessions delivered by professionals and senior practitioners affiliated with institutions such as Ivy League, Stanford, and Cambridge. Content is refreshed each cohort to reflect the latest research and practice.",
        },
        {
            icon: Lightbulb,
    ...
    const scheduleData = {
        ...
        2: [
            ...
            { title: "Negotiation Mastery", subtitle: "Categories, zones of flexibility, and Ivy League-style techniques", type: "negotiation" },
    ...
    const testimonials = [
        {
            name: "Maria Gomez",
            role: "Head of Sixth Form, Madrid",
            content: "Our top set students left with sharper decision frameworks and stronger application narratives. The faculty quality was clear from minute one.",
        },
        {
            name: "Omar Khan",
            role: "Dean, Lahore",
            content: "The workshops balanced academic rigor with practical application. We saw immediate uplift in student confidence and communication.",
        },
        {
            name: "Ethan Lee",
            role: "Executive Participant, Seoul",
            content: "We applied the strategy tools to a real initiative the next day. Clear, modern, and outcome-focused.",
        },
    ];

    const universityLogos = [
        { name: "Ivy League", url: "/images/stanford-logo.png" },
    ...
    const faq = [
        // { q: 'Who delivers the workshops?', a: 'Sessions are designed and taught by professors and senior practitioners affiliated with leading universities (e.g., Ivy League, Stanford, Cambridge). All content follows CPDUK standards and is updated per cohort.' },
        {
            q: "Who delivers the workshops?",
            a: "Sessions are designed and taught by professors and senior practitioners affiliated with leading universities (e.g., Ivy League, Stanford, Cambridge). All content follows professional standards and is updated per cohort.",
        },
        ...
        {
            q: "What accreditation do participants receive?",
            a: "Participants receive professional certificates upon successful completion. Institutions can request customized assessment rubrics aligned to internal outcomes.",
        },
        {
            q: "Who is eligible?",
            a: "High school (advanced English), university students, and executives. We tailor difficulty, pace, and casework by segment. Pre-reads and suggested skill primers are provided.",
        },
        {
            q: "How soon can we run one?",
            a: "From inquiry to delivery is typically ~6 weeks, including alignment, scheduling, and content finalization. Expedited timelines are possible depending on availability.",
        },
        {
            q: "Do you offer custom content?",
            a: "Yes. We tailor by audience, industry focus, and measurable outcomes. Options include extended projects, capstones, and faculty advising hours.",
        },
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 md:py-36">
                    <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-tight max-w-5xl">
                            <span className="bg-gradient-to-r from-white via-gray-100 to-orange-200 bg-clip-text text-transparent">Transform Profiles. Accelerate Futures.</span>
                        </h1>
                        <p className="text-lg md:text-xl text-gray-200 mt-6 max-w-3xl">
                            High-impact workshops with CPDUK-accredited outcomes and international delivery. High-impact workshops with professional certification and international
                            delivery.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 mt-10">
                            <Button size="lg" className="bg-white text-[#1f2444] hover:bg-gray-100 shadow-lg font-semibold" onClick={() => setIsBrochureOpen(true)}>
                            ...
                            <div className="relative group">
                                ...
                                <Button
                                    size="lg"
                                    variant="outline"
                                    className="relative bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#1f2444] font-semibold"
                                >
                        ...
                        <div className="mt-8 flex flex-wrap items-center gap-4 text-gray-200/90">
                            <div className="flex items-center">
                                <Users className="h-5 w-5 mr-2" /> Students & Executives
                            </div>
                            {/* <div className="flex items-center"><ShieldCheck className="h-5 w-5 mr-2" /> CPDUK-Accredited</div> */}
                            <div className="flex items-center">
                                <ShieldCheck className="h-5 w-5 mr-2" /> Professional Certificate
                            </div>
                            <div className="flex items-center">
                                <Globe2 className="h-5 w-5 mr-2" /> Delivered in 20+ Countries
                            </div>
                        </div>
                    </motion.div>
                </div>
                            ...
                            >
                                <div className={`relative bg-gradient-to-r ${w.gradient} rounded-2xl p-[1px] ${w.featured ? "shadow-2xl" : "shadow-lg"}`}>
                                    <Card className={`h-full bg-white rounded-2xl overflow-hidden ${w.featured ? "border-2 border-yellow-400" : ""}`}>
                                        ...
                                        {w.completed && (
                                            <div className="bg-gradient-to-r from-gray-500 to-gray-600 text-white text-center py-2 px-4">
                                                <div className="text-xs font-bold tracking-wide">Registration Closed</div>
                                            </div>
                                        )}
                                        ...
                                        <CardHeader className="pb-4">
                                            <div className="flex justify-between items-start mb-2">
                                                <div
                                                    className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${
                                                        w.audience === "High School"
                                                            ? "bg-blue-100 text-blue-700"
                                                            : w.audience === "University"
                                                            ? "bg-purple-100 text-purple-700"
                                                            : w.audience === "Executive"
                                            ...
                                            <CardTitle className={`font-bold leading-tight ${w.featured ? "text-xl" : "text-lg"}`}>{w.title}</CardTitle>
                                        </CardHeader>
                                        ...
                                        <CardContent className="pt-0">
                                            ...
                                            {/* Learn More button - commented out for completed programs (AI-Powered Communication & Innovation and Entrepreneurship & Startup Strategy), kept for potential future use */}
                                            {/* Button for completed programs:
                                            <Link
                                                to={`/elite-workshops/${w.slug}`}
                                                className={`w-full mt-6 border-0 bg-gradient-to-r from-[#1f2444] to-[#9f162e] hover:from-[#9f162e] hover:to-[#1f2444] text-white font-semibold flex items-center justify-center px-4 py-2 rounded-md transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]`}
                                            >
                                                Learn More
                                            ...
                                            {!w.completed && (
                                                <Link
                                                    ...
                                                    className={`w-full mt-6 border-0 ${
                                                        w.featured
                                                            ? "bg-gradient-to-r from-[#9f162e] to-orange-600 hover:from-orange-600 hover:to-[#9f162e]"
                                                            : "bg-gradient-to-r from-[#1f2444] to-[#9f162e] hover:from-[#9f162e] hover:to-[#1f2444]"
                                                    } text-white font-semibold flex items-center justify-center px-4 py-2 rounded-md transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]`}
                                                >
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600 mt-3 max-w-3xl mx-auto">
                            We collaborate with professors and senior practitioners affiliated with institutions such as Ivy League, Stanford, and Cambridge, bringing cutting-edge
                            knowledge into practical, outcome-focused sessions.
                        </p>
                    </div>
                    {/* Featured Professor */}
                    <div className="mb-8">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                            <div className="md:col-span-1">
                                <div className="relative rounded-2xl overflow-hidden shadow-md">
                                    <img src="/images/nicholas-coburn-palo.svg" alt="Nicholas Coburn-Palo" className="w-full h-64 object-cover rounded-2xl" />
                                    ...
                                    <div className="relative bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                                        <div className="flex items-center mb-2">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-gray-600 text-sm">Ivy League Instructor, ex Yale University</div>
                                            </div>
                                        </div>
                                        <p className="text-gray-700 leading-relaxed">
                                            Nicholas Coburn-Palo teaches communication, public narrative, and leadership with a focus on persuasive performance and executive
                                            presence. His work helps students craft compelling stories, elevate delivery, and communicate with clarity in high-stakes contexts.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="mt-12 text-center">
                        ...
                        <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8 md:gap-10 lg:gap-12 max-w-6xl mx-auto">
                            {universityLogos.map((l, i) => (
                                <div
                                    key={i}
                                    className="flex-shrink-0 w-20 h-16 sm:w-24 sm:h-20 md:w-28 md:h-24 lg:w-32 lg:h-28 flex items-center justify-center bg-white/5 rounded-lg p-2 hover:bg-white/10 transition-all duration-300"
                                >
                                    <img
                                        src={l.url}
                                        alt={`${l.name} logo`}
            ...
            <section className="py-16 md:py-20 lg:py-24 bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                    ...
                    >
                        ...
                        <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 leading-tight">Ideal Partners</h3>
                        <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">Do your students aim for top universities?</p>
                    </motion.div>
                    ...
                    >
                        {[
                            ...
                            >
                                <Icon className={`h-5 w-5 mr-2 transition-transform group-hover:scale-110 ${audienceTab === key ? "text-white" : "text-gray-500"}`} />
                                {label}
                                {audienceTab === key && (
                                    <motion.div
                                        ...
                                        <CardContent className="p-8 md:p-10">
                                            <div className="flex items-start space-x-4">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <p className="text-gray-700 text-lg leading-relaxed">
                                                        High-impact leadership development with executive presence, strategic communication, and organizational transformation
                                                        skills.
                                                    </p>
                                                    <div className="mt-4 flex flex-wrap gap-2">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="relative rounded-2xl overflow-hidden shadow-md group md:col-span-3">
                            <img
                                src="/images/5.png"
                                alt="Cheerful students aiming for top universities"
            ...
            <section className="py-16 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                    ...
                    <div className="relative max-w-7xl mx-auto">
                        ...
                        <div
                            className="hidden lg:block absolute top-16 left-1/2 transform -translate-x-px w-0.5 bg-gradient-to-b from-blue-400 via-cyan-300 to-purple-400"
                            ...
                            {[
                                ...
                                >
                                    ...
                                    <div className={`w-full lg:w-2/5 ${step.side === "right" ? "lg:pl-12" : "lg:pr-12"}`}>
                                        <div className="group relative">
                                            <div
                                                className={`absolute -inset-1 bg-gradient-to-r ${step.color} rounded-2xl blur opacity-30 group-hover:opacity-60 transition-all duration-300`}
                                            ></div>
                                            <div className="relative bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
                                                <div className="flex items-start mb-4">
                                                    <div
                                                        className={`w-12 h-12 rounded-xl bg-gradient-to-r ${step.color} text-white flex items-center justify-center mr-4 text-lg font-bold shadow-lg flex-shrink-0`}
                                                    >
                                                        {step.step}
                                                    </div>
                                                    <div className="flex-1">
                                    ...
                                    <div
                                        className={`hidden lg:block absolute top-1/2 ${step.side === "left" ? "left-1/2 ml-4" : "right-1/2 mr-4"} w-10 h-0.5 bg-gradient-to-r ${
                                            step.color
                                        } opacity-60`}
                                    ></div>
                                </motion.div>
                                            ...
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex items-center gap-4 text-sm text-gray-500">
                                                        ...
                                                        <div className="px-2 py-1 bg-blue-100 text-blue-700 rounded-md text-xs font-medium capitalize">{item.type}</div>
                                                    </div>
                                                </div>
                                                <div className="flex-shrink-0">
                                                    <div className="w-10 h-10 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-lg flex items-center justify-center">
                                                        ...
                                                        ) : item.type === "interactive" || item.type === "group" ? (
                                    ...
                                    >
                                        ...
                                        <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent">
                                            <div className="absolute bottom-4 left-4 text-white">
                                                ...
                                                <p className="text-xs opacity-90">Ivy League-Level Excellence</p>
                                            </div>
                                        </div>
                                    </motion.div>
                                </div>
                    ...
                    >
                        <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 rounded-3xl p-8 md:p-12 relative overflow-hidden">
                            ...
                            <div className="relative">
                                <h4 className="text-2xl md:text-3xl font-bold text-white mb-4">Ready to Transform Your Students' Future?</h4>
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="p-6 space-y-4">
                                <div>
                                    ...
                                    <div className="mt-1 relative">
                                        <input
                                            ...
                                            className={`w-full rounded-lg border px-3 py-2 ${formErrors.name ? "border-red-500" : "border-gray-300"}`}
                                ...
                                <div>
                                    ...
                                    <div className="mt-1 relative">
                                        <input
                                            ...
                                            className={`w-full rounded-lg border px-3 py-2 ${formErrors.email ? "border-red-500" : "border-gray-300"}`}
                                ...
                                <div className="flex items-center justify-end gap-3 pt-2">
                                    <Button type="button" variant="outline" onClick={() => setIsBrochureOpen(false)}>
                                        Cancel
                                    </Button>
                                ...
                                {brochureDownloaded && <p className="text-green-700 text-sm mt-2">Brochure is downloading. We will reach out shortly.</p>}
                            </form>
                        </motion.div>
                    </motion.div>
                )}

            ...
            >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Expert {feature.toLowerCase()} with personalized
                        academic guidance.
                      </p>
                    </div>
                  </motion.div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">
                  Why Choose Our Academic Consulting?
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Comprehensive evaluation of your unique learning
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Customized academic roadmap aligned with your goals and
                        aspirations.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Access to experienced academic consultants and education
                        specialists.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Comprehensive evaluation of academic strengths,
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Development of personalized academic strategy and action
                        plan.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Ongoing guidance and support throughout the
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Regular check-ins and adjustments to ensure optimal
                        outcomes.
                      </p>
                    </div>
                  </div>

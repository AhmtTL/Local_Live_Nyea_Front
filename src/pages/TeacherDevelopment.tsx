...
const TeacherDevelopment: React.FC = () => {
    ...
    const handleEnrollNow = () => {
        // Create program object for Teacher Development
        const program = {
            id: 997,
            title: "Cambridge Teacher Development",
            slug: "teacher-development",
            description: "Official Cambridge Certificate of Professional Development. 2-4 days of intensive training designed to transform teaching excellence.",
            price: 2499,
            formatted_price: "$2,499",
            duration: "2-4 Days",
            category: "Professional Development",
            image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
            features: ["Advanced Teaching Methods", "Classroom Management", "Curriculum Design", "Assessment Strategies", "Educational Technology", "Professional Certification"],
        };
        clearAndEnroll(program as any, 1);
    ...
    const testimonials = [
        ...
        {
            name: "Emma Rodriguez",
            role: "Head of Curriculum, Ivy League Graduate School",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
                            ...
                            <h1 className="text-6xl md:text-8xl font-black mb-8 leading-[0.9] tracking-tight">
                                ...
                                <br />
                                <span className="bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 bg-clip-text text-transparent drop-shadow-lg">EDUCATOR</span>
                                <br />
                                <span className="text-gray-400 text-3xl md:text-4xl font-light">TRANSFORMATION</span>
                            </h1>

                            <p className="text-xl text-gray-300 mb-8 leading-relaxed font-light">
                                Official Cambridge Certificate of Professional Development. 2-4 days of intensive training designed to transform teaching excellence through
                                university-standard methodologies.
                            </p>

                            <div className="flex flex-col sm:flex-row gap-6 mb-8">
                                <Button variant="primary" size="lg" className="group font-black text-lg px-8 py-4 shadow-2xl uppercase tracking-wider" onClick={handleEnrollNow}>
                                ...
                                <Button
                                    variant="outline"
                                    size="lg"
                                    className="bg-black/40 backdrop-blur-md border-yellow-400/30 text-yellow-400 hover:bg-yellow-400/10 font-bold uppercase tracking-wider"
                                >
                                    INTEL BRIEFING
                                </Button>
                            </div>
            ...
            <section className="py-24 bg-gradient-to-br from-blue-50 to-purple-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">Program Features</h2>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">Comprehensive training modules designed by education experts from top universities</p>
                    </motion.div>
            ...
            <section className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">4-Day Curriculum</h2>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">Intensive Cambridge training designed to transform your teaching methodology</p>
                    </motion.div>
                            ...
                            >
                                <Card className="p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/90 backdrop-blur-sm">
                                    <CardHeader className="pb-4">
                                        ...
                                        <CardTitle className="text-2xl font-bold text-gray-900 mb-4">{module.title}</CardTitle>
                                    </CardHeader>
                                    <CardContent>
            ...
            <section className="py-24 bg-gradient-to-br from-blue-50 to-purple-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">What Educators Say</h2>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">Hear from education leaders who have transformed their teaching with our program</p>
                    </motion.div>
            ...
            <section className="py-24 bg-gradient-to-r from-blue-600 to-purple-700 text-white relative overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
                    <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
                        <h2 className="text-5xl md:text-6xl font-bold mb-6">Ready to Transform Your Teaching?</h2>
                        <p className="text-xl mb-12 max-w-3xl mx-auto leading-relaxed opacity-90">
                            Join hundreds of educators who have revolutionized their classrooms. Start your journey to becoming an exceptional teacher today.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-6 justify-center">
                            <Button variant="primary" size="lg" className="shadow-2xl" onClick={handleEnrollNow}>
                                Enroll Now - $2,499
                            </Button>

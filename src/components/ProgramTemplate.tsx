            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <h2 className={`text-2xl md:text-3xl font-bold mb-8 bg-gradient-to-r ${gradient} bg-clip-text text-transparent`}>{subtitle}</h2>
            ...
            <section className={`py-24 bg-gradient-to-br ${gradient} relative overflow-hidden`}>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-white/90 max-w-3xl mx-auto">Discover what makes our program exceptional and transformative</p>
                    </motion.div>
            ...
            <section className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">Transform your future with our comprehensive approach to educational excellence</p>
                    </motion.div>
            ...
            <section className="py-24 bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-300 max-w-3xl mx-auto">Select the perfect plan that fits your educational goals and timeline</p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {packages.map((pkg, index) => (
                            ...
                            >
                                ...
                                <div
                                    className={`absolute -inset-1 bg-gradient-to-r ${pkg.gradient} rounded-3xl blur opacity-25 group-hover:opacity-75 transition duration-1000`}
                                ></div>
                                ...
                                <Card className="relative overflow-hidden border-0 shadow-2xl bg-white/10 backdrop-blur-md border border-white/10">
                                    <CardHeader className="text-center pb-8">
                                        ...
                                        <div className="space-y-2">
                                            <span className={`text-5xl font-black bg-gradient-to-r ${pkg.gradient} bg-clip-text text-transparent`}>${pkg.price}</span>
            ...
            <section className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">Hear from our graduates who transformed their educational journey</p>
                    </motion.div>
                                ...
                                <Card className="p-8 border-0 shadow-xl hover:shadow-2xl transition-all duration-500">
                                    <div className="flex items-center mb-6">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            {testimonial.university && <p className="text-sm text-blue-600 font-semibold">{testimonial.university}</p>}
                                        </div>
                                    </div>
            ...
            <section className={`py-24 bg-gradient-to-r ${gradient} text-white relative overflow-hidden`}>
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
                    <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
                        <h2 className="text-5xl md:text-6xl font-bold mb-6">Ready to Transform Your Future?</h2>
                        <p className="text-xl mb-12 max-w-3xl mx-auto leading-relaxed opacity-90">
                            Join thousands of students who have achieved their dreams through our program. Your journey to excellence starts here.
                        </p>

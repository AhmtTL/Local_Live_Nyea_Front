        ...
        <section className="py-20 md:py-28 lg:py-32 relative overflow-hidden bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-6xl font-semibold text-[#121212] mb-6 md:mb-8 leading-tight">ACADEMIC EXCELLENCE PROGRAMS</h2>
                            ...
                            <div className="relative group">
                                ...
                                >
                                    ...
                                    <CardHeader className="relative p-4">
                                        ...
                                        <CardDescription className="text-[#FAFAFACC] text-sm leading-relaxed line-clamp-2">{program.description}</CardDescription>
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="space-y-1">
                                                {typeof program.price === "number" ? (
                                                    <>
                                                        <span className="text-2xl md:text-3xl lg:text-4xl text-[#FFF675] font-semibold">${program.price.toLocaleString()}</span>
                                                        <div className="text-[#FFFFFFB2] text-xs uppercase tracking-wider">INVESTMENT</div>
                                                    </>
                                                ) : (
                                                    <>
                                                        <span className="text-2xl md:text-3xl lg:text-4xl text-[#FFF675] font-semibold">{program.price}</span>
                                                        <div className="text-[#FFFFFFB2] text-xs uppercase tracking-wider">QUOTE</div>
                                                    </>
                                                )}
                                            </div>
                                            ...
                                            >
                                                <div
                                                    className={`rounded-full p-2 w-11 h-11 flex items-center justify-center ${
                                                        program.id === "nasa-space-training" ? "bg-white" : "bg-[#7F1B28]"
                                                    }`}
                                                >
                                                    <ChevronRight className={`w-6 h-6 ${program.id === "nasa-space-training" ? "text-[#7F1B28]" : "text-white"}`} />
                                                </div>
                                            </Link>
                                        </div>
                                    </CardContent>
                ...
                >
                    <Button variant="learn_more" size="lg" className="group">
                        <Link to="/programs" className="flex items-center gap-x-2">
                            VIEW ALL PROGRAMS
                            <img src="/images/view-all.svg" alt="Arrow Right" width={24} height={24} />
                        </Link>
                    </Button>
                </motion.div>
            </div>

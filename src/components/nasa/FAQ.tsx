  ...
  const faqData = [
    {
      ...
      answer: "The NASA Training Program is a unique and limited STEM field workshop conducted directly by NASA at the Kennedy Space Center in Florida. Through authentic mission simulations and hands-on engineering projects, participants experience real NASA methodologies and cutting-edge technology as part of a comprehensive space science education."
    },
    {
      question: "Am I going to receive a certificate at the end of the program?",
      answer: "Yes, participants who successfully complete the program receive an official NASA certificate, recognizing their training and achievements in the program."
    },
    {
      question: "How long is the program?",
      answer: "The program is offered in two different formats: an 8-day program and a more in-depth 12-day program. Both versions provide immersive, hands-on experiences at the Kennedy Space Center."
    },
    {
      question: "Who can attend the program?",
      answer: "The program is designed for students with a strong interest in STEM fields. It is ideal for high school and university students who are passionate about space science, engineering, and technology, and who wish to learn through NASA's authentic mission-based approach."
    },
    {
      question: "Who can attend the program?",
      answer: "Participants will engage in realistic NASA mission simulations and hands-on engineering projects, using the same tools and methodologies employed by NASA professionals. The training includes comprehensive space science education and direct exposure to cutting-edge technology at the Kennedy Space Center."
    }
  ];
  ...
  return (
    <div className="py-16 md:py-20 lg:py-24 bg-[#FFFFFF]">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* Download Button - Commented out for future use */}
        {/* <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <button 
            onClick={() => {
              ...
              link.href = '/documents/nasa-logosuz_program.pdf';
              link.download = 'nasa-logosuz_program.pdf';

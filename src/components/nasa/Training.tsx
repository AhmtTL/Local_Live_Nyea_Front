...
const Training: React.FC<TrainingProps> = ({ program8Days, program12Days }) => {
  ...
  return (
    <div id="training-section" className="relative py-16 md:py-20 lg:py-24 overflow-hidden">
      {/* Background Image */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {trainingPackages.map((pkg, index) => {
            // Skip rendering if program is not available
            if (!pkg.program) return null;

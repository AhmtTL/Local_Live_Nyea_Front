...
const Hero: React.FC<HeroProps> = ({ config }) => {
    // Format date range from config dates
                ...
                <div className="relative z-10 text-center max-w-7xl mx-auto px-4 space-y-12">
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            >
                                <span className="block text-lg md:text-xl lg:text-2xl font-bold text-yellow-400">2K26</span>
                                Future CEO
                    ...
                    <div className="space-y-4">
                        ...
                        >
                            <Link
                                to="/ivy-league-future-ceo-booking/ivy-league-ceo"
                            ...
                            >
                                ...
                                <img src="/images/explore.svg" alt="Arrow Right" width={24} height={24} className="ml-2" />
                            </Link>
                            <a
                                href="#itinerary"
                            ...
                            >
                                ...
                                <img src="/images/view-all.svg" alt="Arrow Right" width={24} height={24} className="ml-2" />
                            </a>
                        </motion.div>
                        ...
                        >
                            <div className="flex items-center gap-x-1">
                                ...
                                <span>
                                    Led by <span className="text-[#FACC15] font-medium">{config.ledBy}</span>
                                </span>
                            </div>
                    ...
                    <div className="bg-white rounded-[20px] shadow-2xl mx-auto p-4">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div className="relative h-64 lg:h-auto">
                                <img src="/images/future-1.jpeg" alt="Future CEO Program" className="w-full h-full object-cover rounded-[10px]" />
                            </div>
                            ...
                            <div className="flex flex-col gap-y-4 h-full">
                                <div className="bg-[#F5F5F5] rounded-xl p-4 flex flex-col items-center justify-center text-center gap-y-2 h-full">
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-[#7C1B25] text-xs font-semibold uppercase">Training Date</p>
                                    </div>

                                    <div className="space-y-0">
                                        <p className="text-[#121212] text-xl md:text-3xl font-bold">{dateRange}</p>
                                        <p className="text-[#555555] text-sm font-semibold">(2 weeks)</p>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 h-full">
                                    <div className="bg-[#F5F5F5] rounded-xl p-4 flex flex-col items-center justify-center text-center gap-y-2 h-full">
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-[#7C1B25] text-xs font-semibold uppercase">Registration Fee</p>
                                        </div>
                                    ...
                                    <div className="bg-[#F5F5F5] rounded-xl p-4 flex flex-col items-center justify-center text-center gap-y-2 h-full">
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-[#7C1B25] text-xs font-semibold uppercase">Limited to</p>
                                        </div>
                                        <div className="text-[#121212] text-xl md:text-3xl font-bold">{config.capacity} Students</div>
                                    </div>
                                </div>
                            </div>
                        </div>

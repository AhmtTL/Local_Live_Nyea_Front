            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                <div className="space-y-3">
                  <a
                    href="mailto:hello@nyempireacademy.com"
                    onClick={(e) => {
                      e.preventDefault();
                      window.location.href = 'mailto:hello@nyempireacademy.com';
                    }}
                    className="flex items-center space-x-3 group cursor-pointer hover:translate-x-1 transition-all duration-200"
                  >
                    <div className="w-8 h-8 bg-[#9f162e]/10 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-[#9f162e]/20 transition-colors">
                      <Mail className="h-4 w-4 text-[#9f162e]" />
                    </div>
                    <span className="text-white/90 group-hover:text-white text-sm transition-colors">
                      hello@nyempireacademy.com
                    </span>
                  </a>
                  <a 
                    href="tel:+13478913911" 
                    className="flex items-center space-x-3 group cursor-pointer hover:translate-x-1 transition-all duration-200"
                  >
                    <div className="w-8 h-8 bg-[#9f162e]/10 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-[#9f162e]/20 transition-colors">
                  ...
                  <a 
                    href="https://www.google.com/maps/search/?api=1&query=Empire+State+Building,+20+W+34th+street,+New+York" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex items-start space-x-3 group cursor-pointer hover:translate-x-1 transition-all duration-200"
                  >
                    <div className="w-8 h-8 bg-[#9f162e]/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5 group-hover:bg-[#9f162e]/20 transition-colors">
                      <MapPin className="h-4 w-4 text-[#9f162e]" />
                    </div>
                    <span className="text-white/90 group-hover:text-white text-sm leading-relaxed transition-colors">
                      Empire State Building, 20 W 34th street, New York
                    </span>
                  </a>
                </div>
              </motion.div>

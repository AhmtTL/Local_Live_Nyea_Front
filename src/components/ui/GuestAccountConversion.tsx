...
const GuestAccountConversion: React.FC<GuestAccountConversionProps> = ({
  ...
  const handleConversion = async () => {
    ...
    try {     
      const data = await apiClient.convertGuestToUser({
        ...formData,
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleConversion(); }} className="space-y-4">
          ...
          <div>
            ...
            {formErrors.firstName && (
              <p className="mt-1 text-sm text-red-600">{formErrors.firstName[0]}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {formErrors.lastName && (
              <p className="mt-1 text-sm text-red-600">{formErrors.lastName[0]}</p>
            )}
          </div>
